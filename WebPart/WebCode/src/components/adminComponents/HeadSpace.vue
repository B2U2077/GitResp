<template>
    ...
    <div>
        <div style="float: left">
            <i @click="change_aside_state" :class="aside_state == true ? 'el-icon-s-fold' : 'el-icon-s-unfold'"
                id="head_icon" />
        </div>
...
<script>
    import SettingSpace from '@/components/adminComponents/unit/SettingSpace'
