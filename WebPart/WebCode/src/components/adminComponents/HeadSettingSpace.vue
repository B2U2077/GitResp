<template>
    <div>
        <i class="el-icon-setting" @click="visible_state = true" :style="{ color: head_icon_color }"></i>
        <el-drawer title="我是标题" :with-header="false" :visible.sync="visible_state">
            <el-card shadow="never" style="min-height: 100vh">
                ...
                <div>
                    <span>组件库：</span>
                    <a v-for="(com, index) in com_data" :key="index" :href="com.com_link" target="_blank"
